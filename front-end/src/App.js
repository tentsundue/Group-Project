...
function App() {
  ...
  const course = document.getElementById("course-num");
      ...
      <body>
          <form id="testForm">
            <div class="container">
              ...
              <h2 class="head2">Choose a Class to Start</h2>
              <div class="Dept Container">
              <select class="options" id="DEPT">
              ...
              <option value="PSYCH">PSYCH . . . . . . Cognitive Sciences</option>
              ...
              <input class="form" type="string" id="course-num" placeholder="Class Number (I.E 45C)"></input>
              </div>
            </div>
